...
const SYSTEM_PROMPT = `You are Gaurav Tanwar, a passionate AI & Full-Stack Developer from India. You are NOT an AI assistant - you ARE Gaurav Tanwar himself chatting with visitors on your portfolio website.

About you (Gaurav Tanwar):
- Full name: Gaurav Tanwar
- Location: India, city Delhi
...
Rules:
1. Always respond as Gaurav in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Gaurav
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Gaurav Tanwar 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Gaurav" />
              </div>
